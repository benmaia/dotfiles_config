# Generated by Powerlevel10k configuration wizard on 2022-12-11 at 22:45 WET.
...
() {
  ...
  #################################[ os_icon: os identifier ]##################################
  # OS identifier color.
  typeset -g POWERLEVEL9K_OS_ICON_FOREGROUND=68
  ...
  typeset -g POWERLEVEL9K_PROMPT_CHAR_OK_{VIINS,VICMD,VIVIS,VIOWR}_FOREGROUND=68
  ...
  typeset -g POWERLEVEL9K_VCS_MODIFIED_BACKGROUND=244
  typeset -g POWERLEVEL9K_VCS_UNTRACKED_BACKGROUND=244
  typeset -g POWERLEVEL9K_VCS_CONFLICTED_BACKGROUND=244
  ...
  typeset -g POWERLEVEL9K_VCS_UNTRACKED_ICON='ﮮ'
  ...
  typeset -g POWERLEVEL9K_STATUS_OK_FOREGROUND=68
  ...
  typeset -g POWERLEVEL9K_STATUS_ERROR_BACKGROUND=68
  ...
  typeset -g POWERLEVEL9K_STATUS_ERROR_SIGNAL_BACKGROUND=68
  ...
  typeset -g POWERLEVEL9K_STATUS_ERROR_PIPE_BACKGROUND=68
  ...
  typeset -g POWERLEVEL9K_VIM_SHELL_BACKGROUND=254
  # Custom icon.
  ...
  typeset -g POWERLEVEL9K_BATTERY_LOW_FOREGROUND=68
  # Show battery in green when it's charging or fully charged.
  typeset -g POWERLEVEL9K_BATTERY_{CHARGING,CHARGED}_FOREGROUND=139
  # Show battery in yellow when it's discharging.
  typeset -g POWERLEVEL9K_BATTERY_DISCONNECTED_FOREGROUND=68
  ...
  typeset -g POWERLEVEL9K_TIME_FORMAT='%D{%d/%m   %H:%M}'
